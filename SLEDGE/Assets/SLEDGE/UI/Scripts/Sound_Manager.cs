...
public class Sound_Manager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        */
        ...
        AudioManager.Instance.masterVolume = master_slider.value / 100;
        AudioManager.Instance.musicVolume = music_slider.value / 100;
        AudioManager.Instance.sfxVolume = sfx_slider.value / 100;
    }
